...
import { fetchAddressSuggestions, fetchPlaceDetails, fetchAddressFromCoordinates } from '../helper/locationUtils';
...
export default function Register() {
    ...
    const handleSuggestionSelect = async (place) => {
        ...
        console.log("Selected Place Coordinates: ", { latitude, longitude }); // Debugging line
                        ...
                        <form className='py-1' onSubmit={formik.handleSubmit}>
                            <div className='profile flex justify-center py-4'>
                                <label htmlFor="profile">
                                    <img src={file ? URL.createObjectURL(file) : avatar} alt="avatar" className={styles.avatar} />
                                </label>
